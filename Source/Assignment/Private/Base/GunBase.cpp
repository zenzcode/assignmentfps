...
FHitResult AGunBase::Shoot()
{
	...
	UNiagaraFunctionLibrary::SpawnSystemAttached(MuzzleFlashSystem, GunMesh, TEXT("Muzzle"), FVector(MuzzleDistance, 0.f, 0.f), FRotator(0.f, -90.f, 0.f), EAttachLocation::KeepRelativeOffset, true);
